...
import 'package:play_iq/Scan/puzzle_screen.dart';
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Text("M", style: _letterStyle()),
                SizedBox(width: 10),
                Text("A", style: _letterStyle()),
                SizedBox(width: 10),
                Text("L", style: _letterStyle()),
                SizedBox(width: 10),
                Text("L", style: _letterStyle()),
              ],
            ),
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PuzzleCompletedView()));
                  },
                  child: Text(
                    'FINISH',
                    style: TextStyle(
